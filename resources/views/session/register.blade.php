...
@section('content')
  ...
  <section class="mb-8" style="background:#BFD7ED; padding: 10px;">
    <div class="page-header align-items-start pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('../assets/img/curved-images/curved14.jpg');">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" style="background:#1B3FAB;">Sign up</button>
                </div>
